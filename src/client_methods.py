...
class Mixin:
    ...
    Resets the existing license key for this account to a new key.
      ...
      :param id [int] The ID of the account you wish to update.
    ...
    """
    def account_reset_license_key(self, id, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/{id}/resetlicensekey", 
    ...
    Activate the account specified by the unique accountId number.
      ...
      :param id [int] The ID of the account to activate
      ...
      :return AccountModel
    """
    def activate_account(self, id, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/accounts/{id}/activate", 
                auth=self.auth, headers=self.client_header,
    ...
    Get the account object identified by this URL.
      ...
      * Users
      ...
      :return AccountModel
    """
    def get_account(self, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    """
    def get_account_configuration(self, id):
        return requests.get(f"{self.base_url}/api/v2/accounts/{id}/configuration", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Update configuration settings tied to this account.
      ...
      :return AccountConfigurationModel
    """
    def set_account_configuration(self, id, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/{id}/configuration", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def resolve_address(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/addresses/resolve", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def resolve_address_post(self, model):
        return requests.post(f"{self.base_url}/api/v2/addresses/resolve", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_batches(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/batches", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Delete a single batch
      ...
      :param companyId [int] The ID of the company that owns this batch.
      :param id [int] The ID of the batch you wish to delete.
      :return ErrorDetail
    """
    def delete_batch(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/batches/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Download a single batch file identified by this URL.
      ...
      :param id [int] The primary key of this batch file object
      :return String
    """
    def download_batch(self, companyId, batchId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/batches/{batchId}/files/{id}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the batch object identified by this URL.
      ...
      :param companyId [int] The ID of the company that owns this batch
      :param id [int] The primary key of this batch
      :return BatchModel
    """
    def get_batch(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/batches/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_batches_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/batches", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_batches(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/batches", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def create_cert_express_invitation(self, companyId, customerCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certexpressinvites", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Retrieve an existing CertExpress invitation sent to a customer.
      ...
      :param customerCode [string] The number of the customer where the request is sent to
      :param id [int] The unique ID number of this CertExpress invitation
    ...
    """
    def get_cert_express_invitation(self, companyId, customerCode, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certexpressinvites/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_cert_express_invitations(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certexpressinvites", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def create_certificates(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Revoke the certificate identified by this URL, then delete it.
      ...
      :param id [int] The unique ID number of this certificate
      :return CertificateModel
    """
    def delete_certificate(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Download an image or PDF file for this certificate.
      ...
      :return String
    """
    def download_certificate_image(self, companyId, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Get the current certificate identified by this URL.
      ...
      * Attributes - Retrieves all attributes applied to the certificate.
      ...
      :return CertificateModel
    """
    def get_certificate(self, companyId, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def get_certificate_setup(self, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates/setup", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Link one or many attributes to a certificate.
      ...
      :return FetchResult
    """
    def link_attributes_to_certificate(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/attributes/link", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Link one or more customers to an existing certificate.
      ...
      :return FetchResult
    """
    def link_customers_to_certificate(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/customers/link", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Retrieve the list of attributes that are linked to this certificate.
      ...
      :return FetchResult
    """
    def list_attributes_for_certificate(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/attributes", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    List all customers linked to this certificate.
      ...
      :return FetchResult
    """
    def list_customers_for_certificate(self, companyId, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/customers", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_certificates(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/certificates", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def request_certificate_setup(self, companyId):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/setup", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Unlink one or many attributes from a certificate.
      ...
      :return FetchResult
    """
    def unlink_attributes_from_certificate(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/attributes/unlink", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Unlinks one or more customers from a certificate.
      ...
      :return FetchResult
    """
    def unlink_customers_from_certificate(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/customers/unlink", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Replace the certificate identified by this URL with a new one.
      ...
      :return CertificateModel
    """
    def update_certificate(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Upload an image or PDF attachment for this certificate.
      ...
      :return string
    """
    def upload_certificate_image(self, companyId, id):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/certificates/{id}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Changes the current filing status of this company.
      ...
      * Avalara compliance team members may change a company from `FirstFiling` to `Active`.
      ...
      :return string
    """
    def change_filing_status(self, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{id}/filingstatus", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def company_initialize(self, model):
        return requests.post(f"{self.base_url}/api/v2/companies/initialize", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_companies(self, model):
        return requests.post(f"{self.base_url}/api/v2/companies", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The unique identifier of the company
      :param model [FundingInitiateModel] The funding initialization request
      :return FundingStatusModel
    """
    def create_funding_request(self, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{id}/funding/setup", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Deleting a company will delete all child companies, and all users attached to this company.
      ...
      :param id [int] The ID of the company you wish to delete.
      :return ErrorDetail
    """
    def delete_company(self, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def funding_configuration_by_company(self, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/funding/configuration", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def funding_configurations_by_company_and_currency(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/funding/configurations", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Get the company object identified by this URL.
      ...
      :param id [int] The ID of the company to retrieve.
      ...
      :return CompanyModel
    """
    def get_company(self, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    """
    def get_company_configuration(self, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{id}/configuration", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Retrieve the current filing status of this company.
      ...
      * `Active` - The company is currently active and is filing tax returns via Avalara Managed Returns.
      ...
      :return string
    """
    def get_filing_status(self, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{id}/filingstatus", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FundingStatusModel
    """
    def list_funding_requests_by_company(self, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{id}/funding", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_mrs_companies(self):
        return requests.get(f"{self.base_url}/api/v2/companies/mrs", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def query_companies(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Update configuration settings tied to this account.
      ...
      :return CompanyConfigurationModel
    """
    def set_company_configuration(self, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{id}/configuration", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Replace the existing company object at this URL with an updated object.
      ...
      :param id [int] The ID of the company you wish to update.
      :param model [CompanyModel] The company object you wish to update.
      :return CompanyModel
    """
    def update_company(self, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_contacts(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/contacts", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Mark the existing contact object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this contact.
      :param id [int] The ID of the contact you wish to delete.
      :return ErrorDetail
    """
    def delete_contact(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/contacts/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the contact object identified by this URL.
      ...
      :param id [int] The primary key of this contact
      :return ContactModel
    """
    def get_contact(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/contacts/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_contacts_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/contacts", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_contacts(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/contacts", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing contact object at this URL with an updated object.
      ...
      :param id [int] The ID of the contact you wish to update
      :param model [ContactModel] The contact you wish to update.
      :return ContactModel
    """
    def update_contact(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/contacts/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_customers(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/customers", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def delete_customer(self, companyId, customerCode):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_customer(self, companyId, customerCode, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def link_certificates_to_customer(self, companyId, customerCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certificates/link", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def list_certificates_for_customer(self, companyId, customerCode, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certificates", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_valid_certificates_for_customer(self, companyId, customerCode, country, region):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certificates/{country}/{region}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def query_customers(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/customers", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def unlink_certificates_from_customer(self, companyId, customerCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}/certificates/unlink", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def update_customer(self, companyId, customerCode, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/customers/{customerCode}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def get_cross_border_code(self, country, hsCode):
        return requests.get(f"{self.base_url}/api/v2/definitions/crossborder/{country}/{hsCode}/hierarchy", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_login_verifier_by_form(self, form, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/filingcalendars/loginverifiers/{form}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_ava_file_forms(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/avafileforms", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_certificate_attributes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/certificateattributes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_certificate_exempt_reasons(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/certificateexemptreasons", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_certificate_exposure_zones(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/certificateexposurezones", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Returns full list of communications transaction types which
      ...
      :param id [int] The transaction type ID to examine
      :param filter [string] A filter statement to identify specific records to retrieve. For more information on filtering, see [Filtering in REST](http://developer.avalara.com/avatax/filtering-in-rest/) .
      :param top [int] If nonzero, return no more than this number of results. Used with $skip to provide pagination for large datasets.
      :param skip [int] If nonzero, skip this number of results before returning data. Used with $top to provide pagination for large datasets.
      :param orderBy [string] A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
      :return FetchResult
    """
    def list_communications_service_types(self, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/communications/transactiontypes/{id}/servicetypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_communications_transaction_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/communications/transactiontypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_communications_t_s_pairs(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/communications/tspairs", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_countries(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/countries", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_cover_letters(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/coverletters", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Retrieves a list of HS Codes that are the children of the prefix for the given destination country, if
      ...
      :return FetchResult
    """
    def list_cross_border_codes(self, country, hsCode):
        return requests.get(f"{self.base_url}/api/v2/definitions/crossborder/{country}/{hsCode}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_cross_border_sections(self):
        return requests.get(f"{self.base_url}/api/v2/definitions/crossborder/sections", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_currencies(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/currencies", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_entity_use_codes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/entityusecodes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_filing_frequencies(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/filingfrequencies", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_jurisdictions(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/jurisdictions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_jurisdictions_by_address(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/jurisdictionsnearaddress", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_location_questions_by_address(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/locationquestions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_login_verifiers(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/filingcalendars/loginverifiers", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexus", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus_by_address(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexus/byaddress", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus_by_country(self, country, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexus/{country}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus_by_country_and_region(self, country, region, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexus/{country}/{region}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus_by_form_code(self, formCode, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexus/byform/{formCode}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_nexus_tax_type_groups(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/nexustaxtypegroups", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_customer_funding_options(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticecustomerfundingoptions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_customer_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticecustomertypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_filingtypes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticefilingtypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_priorities(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticepriorities", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_reasons(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticereasons", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_responsibilities(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticeresponsibilities", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_root_causes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticerootcauses", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_statuses(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticestatuses", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_notice_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/noticetypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_parameters(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/parameters", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_permissions(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/permissions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_postal_codes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/postalcodes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_preferred_programs(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/preferredprograms", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_rate_types_by_country(self, country, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/countries/{country}/ratetypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_regions(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/regions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_regions_by_country(self, country, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/countries/{country}/regions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_resource_file_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/resourcefiletypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_security_roles(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/securityroles", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_subscription_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/subscriptiontypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_authorities(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxauthorities", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_authority_forms(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxauthorityforms", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_authority_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxauthoritytypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_codes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxcodes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_code_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxcodetypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_forms(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxforms", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_sub_types(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxsubtypes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_tax_type_groups(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/taxtypegroups", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_unit_of_measurement(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/definitions/unitofmeasurements", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def create_distance_threshold(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/distancethresholds", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the DistanceThreshold object identified by this URL as deleted.
      ...
      :param companyId [int] The unique ID number of the company that owns this DistanceThreshold
      :param id [int] The unique ID number of the DistanceThreshold object you wish to delete.
      :return ErrorDetail
    """
    def delete_distance_threshold(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/distancethresholds/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Retrieves a single DistanceThreshold object defined by this URL.
      ...
      :param id [int] The unique ID number referring to this DistanceThreshold object
      :return CompanyDistanceThresholdModel
    """
    def get_distance_threshold(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/distancethresholds/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_distance_thresholds(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/distancethresholds", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_distance_thresholds(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/distancethresholds", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing DistanceThreshold object at this URL with an updated object.
      ...
      :param id [int] The unique ID number of the DistanceThreshold object to replace.
      :param model [CompanyDistanceThresholdModel] The new DistanceThreshold object to store.
      :return CompanyDistanceThresholdModel
    """
    def update_distance_threshold(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/distancethresholds/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The unique ID of the filing request object
      :return FilingRequestModel
    """
    def approve_filing_request(self, companyId, id):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingrequests/{id}/approve", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FilingRequestModel
    """
    def cancel_filing_request(self, companyId, id):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingrequests/{id}/cancel", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The unique ID number of the filing calendar to cancel
      :param model [FilingRequestModel] The cancellation request for this filing calendar
      :return FilingRequestModel
    """
    def cancel_filing_requests(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}/cancel/request", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_filing_calendars(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_filing_requests(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/add/request", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def cycle_safe_add(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/add/options", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The unique ID of the company that owns the filing calendar object
      :param id [int] The unique ID of the filing calendar object
      :param model [FilingCalendarEditModel] A list of filing calendar edits to be made
      :return CycleEditOptionModel
    """
    def cycle_safe_edit(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}/edit/options", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    """
    def cycle_safe_expiration(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}/cancel/options", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the filing calendar you wish to delete.
      :return ErrorDetail
    """
    def delete_filing_calendar(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns this filing calendar
      :param id [int] The primary key of this filing calendar
      :return FilingCalendarModel
    """
    def get_filing_calendar(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FilingRequestModel
    """
    def get_filing_request(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingrequests/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_filing_calendars(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_filing_requests(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filingrequests", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def login_verification_request(self, model):
        return requests.post(f"{self.base_url}/api/v2/filingcalendars/credentials/verify", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def login_verification_status(self, jobId):
        return requests.get(f"{self.base_url}/api/v2/filingcalendars/credentials/{jobId}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def query_filing_calendars(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/filingcalendars", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_filing_requests(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/filingrequests", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The unique ID of the company that owns the filing calendar object
      :param id [int] The unique ID number of the filing calendar to edit
      :param model [FilingRequestModel] A list of filing calendar edits to be made
      :return FilingRequestModel
    """
    def request_filing_calendar_update(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}/edit/request", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :return FilingCalendarModel
    """
    def update_filing_calendar(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/filingcalendars/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :return FilingRequestModel
    """
    def update_filing_request(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/filingrequests/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def approve_filings(self, companyId, year, month, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/approve", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def approve_filings_country(self, companyId, year, month, country, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/approve", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def approve_filings_country_region(self, companyId, year, month, country, region, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/approve", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_return_adjustment(self, companyId, year, month, country, region, formCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/{formCode}/adjust", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_return_augmentation(self, companyId, year, month, country, region, formCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/{formCode}/augment", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_return_payment(self, companyId, year, month, country, region, formCode, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/{formCode}/payment", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being adjusted.
      :param id [int] The ID of the adjustment being deleted.
      :return ErrorDetail
    """
    def delete_return_adjustment(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/filings/adjust/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being changed.
      :param id [int] The ID of the augmentation being added.
      :return ErrorDetail
    """
    def delete_return_augmentation(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/filings/augment/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being adjusted.
      :param id [int] The ID of the payment being deleted.
      :return ErrorDetail
    """
    def delete_return_payment(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/filings/payment/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def filings_checkup_report(self, filingsId, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{filingsId}/checkup", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def filings_checkup_reports(self, companyId, year, month):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/checkup", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filing_attachment(self, companyId, filingReturnId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{filingReturnId}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def get_filing_attachments(self, companyId, year, month):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/attachments", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filing_attachments_trace_file(self, companyId, year, month):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/attachments/tracefile", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filings.
      :param id [int] The id of the filing return your retrieving
      :return FetchResult
    """
    def get_filing_return(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/returns/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filings(self, companyId, year, month):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filings_by_country(self, companyId, year, month, country):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filings_by_country_region(self, companyId, year, month, country, region):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filings_by_return_name(self, companyId, year, month, country, region, formCode):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/{formCode}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_filings_returns(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/filings/returns", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def rebuild_filings(self, companyId, year, month, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/rebuild", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def rebuild_filings_by_country(self, companyId, year, month, country, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/rebuild", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def rebuild_filings_by_country_region(self, companyId, year, month, country, region, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/filings/{year}/{month}/{country}/{region}/rebuild", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being adjusted.
      :param id [int] The ID of the adjustment being edited.
      :param model [FilingAdjustmentModel] The updated Adjustment.
      :return FilingAdjustmentModel
    """
    def update_return_adjustment(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/filings/adjust/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being changed.
      :param id [int] The ID of the augmentation being edited.
      :param model [FilingAugmentationModel] The updated Augmentation.
      :return FilingModel
    """
    def update_return_augmentation(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/filings/augment/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns the filing being adjusted.
      :param id [int] The ID of the payment being edited.
      :param model [FilingPaymentModel] The updated Payment.
      :return FilingPaymentModel
    """
    def update_return_payment(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/filings/payment/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def request_free_trial(self, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/freetrials/request", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def tax_rates_by_address(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/taxrates/byaddress", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def tax_rates_by_postal_code(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/taxrates/bypostalcode", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The unique ID number of this funding request
      :return FundingStatusModel
    """
    def activate_funding_request(self, id):
        return requests.get(f"{self.base_url}/api/v2/fundingrequests/{id}/widget", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FundingStatusModel
    """
    def funding_request_status(self, id):
        return requests.get(f"{self.base_url}/api/v2/fundingrequests/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def create_items(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/items", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the item object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this item.
      :param id [int] The ID of the item you wish to delete.
      :return ErrorDetail
    """
    def delete_item(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/items/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the item object identified by this URL.
      ...
      :param id [int] The primary key of this item
      :return ItemModel
    """
    def get_item(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/items/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_items_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/items", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_items(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/items", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing `Item` object at this URL with an updated object.
      ...
      :param id [int] The ID of the item you wish to update
      :param model [ItemModel] The item object you wish to update.
      :return ItemModel
    """
    def update_item(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/items/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_jurisdiction_overrides(self, accountId, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/{accountId}/jurisdictionoverrides", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the item object at this URL as deleted.
      ...
      :param accountId [int] The ID of the account that owns this override
      :param id [int] The ID of the override you wish to delete
      :return ErrorDetail
    """
    def delete_jurisdiction_override(self, accountId, id):
        return requests.delete(f"{self.base_url}/api/v2/accounts/{accountId}/jurisdictionoverrides/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the item object identified by this URL.
      ...
      :param accountId [int] The ID of the account that owns this override
      :param id [int] The primary key of this override
      :return JurisdictionOverrideModel
    """
    def get_jurisdiction_override(self, accountId, id):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/jurisdictionoverrides/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_jurisdiction_overrides_by_account(self, accountId, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/jurisdictionoverrides", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_jurisdiction_overrides(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/jurisdictionoverrides", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing jurisdictionoverride object at this URL with an updated object.
      ...
      :param id [int] The ID of the jurisdictionoverride you wish to update
      :param model [JurisdictionOverrideModel] The jurisdictionoverride object you wish to update.
      :return JurisdictionOverrideModel
    """
    def update_jurisdiction_override(self, accountId, id, model):
        return requests.put(f"{self.base_url}/api/v2/accounts/{accountId}/jurisdictionoverrides/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_locations(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/locations", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Mark the location object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this location.
      :param id [int] The ID of the location you wish to delete.
      :return ErrorDetail
    """
    def delete_location(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/locations/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the location object identified by this URL.
      ...
      * LocationSettings
      ...
      :param companyId [int] The ID of the company that owns this location
      :param id [int] The primary key of this location
      ...
      :return LocationModel
    """
    def get_location(self, companyId, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/locations/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_locations_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/locations", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_locations(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/locations", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing location object at this URL with an updated object.
      ...
      :param id [int] The ID of the location you wish to update
      :param model [LocationModel] The location you wish to update.
      :return LocationModel
    """
    def update_location(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/locations/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    """
    def validate_location(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/locations/{id}/validate", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def adjust_multi_document_transaction(self, code, type, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument/{code}/type/{type}/adjust", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def audit_multi_document_transaction(self, code, type):
        return requests.get(f"{self.base_url}/api/v2/transactions/multidocument/{code}/type/{type}/audit", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def commit_multi_document_transaction(self, model):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument/commit", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_multi_document_transaction(self, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def get_multi_document_transaction_by_code_and_type(self, code, type, include=None):
        return requests.get(f"{self.base_url}/api/v2/transactions/multidocument/{code}/type/{type}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Get the unique MultiDocument transaction identified by this URL.
      ...
      * LinesOnly (omit details - reduces API response size)
      ...
      :param id [int] The unique ID number of the MultiDocument transaction to retrieve
      :param include [string] Specifies objects to include in the response after transaction is created
      :return MultiDocumentModel
    """
    def get_multi_document_transaction_by_id(self, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/transactions/multidocument/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_multi_document_transactions(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/transactions/multidocument", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def refund_multi_document_transaction(self, code, type, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument/{code}/type/{type}/refund", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def verify_multi_document_transaction(self, model):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument/verify", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def void_multi_document_transaction(self, code, type, model):
        return requests.post(f"{self.base_url}/api/v2/transactions/multidocument/{code}/type/{type}/void", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_nexus(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/nexus", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the existing nexus object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this nexus.
      :param id [int] The ID of the nexus you wish to delete.
      :return ErrorDetail
    """
    def delete_nexus(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/nexus/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the nexus object identified by this URL.
      ...
      :param id [int] The primary key of this nexus
      :return NexusModel
    """
    def get_nexus(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/nexus/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def get_nexus_by_form_code(self, companyId, formCode):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/nexus/byform/{formCode}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_nexus_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/nexus", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_nexus(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/nexus", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing nexus object at this URL with an updated object.
      ...
      :param id [int] The ID of the nexus you wish to update
      :param model [NexusModel] The nexus object you wish to update.
      :return NexusModel
    """
    def update_nexus(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/nexus/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the tax notice we are adding the comment for.
      :param model [NoticeCommentModel] The notice comments you wish to create.
      :return NoticeCommentModel
    """
    def create_notice_comment(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/comments", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns this notice.
      :param id [int] The ID of the notice added to the finance details.
      :param model [NoticeFinanceModel] The notice finance details you wish to create.
      :return NoticeFinanceModel
    """
    def create_notice_finance_details(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/financedetails", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns this notice.
      :param id [int] The ID of the tax notice we are adding the responsibility for.
    ...
    """
    def create_notice_responsibilities(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/responsibilities", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    """
    def create_notice_root_causes(self, companyId, id, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/rootcauses", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_notices(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns this notice.
      :param id [int] The ID of the notice you wish to delete.
      :return ErrorDetail
    """
    def delete_notice(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the responsibility you wish to delete.
      :return ErrorDetail
    """
    def delete_responsibilities(self, companyId, noticeId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/notices/{noticeId}/responsibilities/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param companyId [int] The ID of the company that owns this notice.
      :param noticeId [int] The ID of the notice you wish to delete.
      :param id [int] The ID of the root cause you wish to delete.
      :return ErrorDetail
    """
    def delete_root_causes(self, companyId, noticeId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/notices/{noticeId}/rootcauses/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ResourceFileId of the attachment to download.
      :return String
    """
    def download_notice_attachment(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/files/{id}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of this notice.
      :return NoticeModel
    """
    def get_notice(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the notice.
      :param companyId [int] The ID of the company that owns these notices.
      :return FetchResult
    """
    def get_notice_comments(self, id, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/comments", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the company that owns these notices.
      :param companyId [int] The ID of the company that owns these notices.
      :return FetchResult
    """
    def get_notice_finance_details(self, id, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/financedetails", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FetchResult
    """
    def get_notice_responsibilities(self, id, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/responsibilities", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    This API is available by invitation only.
      ...
      :return FetchResult
    """
    def get_notice_root_causes(self, id, companyId):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}/rootcauses", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_notices_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/notices", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_notices(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/notices", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    This API is available by invitation only.
      ...
      :param id [int] The ID of the notice you wish to update.
      :param model [NoticeModel] The notice object you wish to update.
      :return NoticeModel
    """
    def update_notice(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/notices/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def upload_attachment(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/notices/files/attachment", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def request_new_account(self, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/request", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def change_password(self, model):
        return requests.put(f"{self.base_url}/api/v2/passwords", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_account(self, model):
        return requests.post(f"{self.base_url}/api/v2/accounts", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_subscriptions(self, accountId, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/{accountId}/subscriptions", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    # For Registrar Use Only
      ...
      :param id [int] The ID of the account you wish to delete.
      :return ErrorDetail
    """
    def delete_account(self, id):
        return requests.delete(f"{self.base_url}/api/v2/accounts/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    # For Registrar Use Only
      ...
      :param accountId [int] The ID of the account that owns this subscription.
      :param id [int] The ID of the subscription you wish to delete.
      :return ErrorDetail
    """
    def delete_subscription(self, accountId, id):
        return requests.delete(f"{self.base_url}/api/v2/accounts/{accountId}/subscriptions/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    # For Registrar Use Only
      ...
      :param id [int] The ID of the user you wish to delete.
      :param accountId [int] The accountID of the user you wish to delete.
      :return ErrorDetail
    """
    def delete_user(self, id, accountId):
        return requests.delete(f"{self.base_url}/api/v2/accounts/{accountId}/users/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def query_accounts(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def reset_password(self, userId, model):
        return requests.post(f"{self.base_url}/api/v2/passwords/{userId}/reset", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    # For Registrar Use Only
      ...
      :return AccountModel
    """
    def update_account(self, id, model):
        return requests.put(f"{self.base_url}/api/v2/accounts/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    # For Registrar Use Only
      ...
      :param id [int] The ID of the subscription you wish to update
      :param model [SubscriptionModel] The subscription you wish to update.
      :return SubscriptionModel
    """
    def update_subscription(self, accountId, id, model):
        return requests.put(f"{self.base_url}/api/v2/accounts/{accountId}/subscriptions/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    This API downloads the file associated with a report.
      ...
      * When a report's status is `Completed`, call `DownloadReport` to retrieve the file.
      ...
      :param id [int] The unique ID number of this report
      :return String
    """
    def download_report(self, id):
        return requests.get(f"{self.base_url}/api/v2/reports/{id}/attachment", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def export_document_line(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/reports/exportdocumentline", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Retrieve a single report by its unique ID number.
      ...
      * When a report's status is `Completed`, call `DownloadReport` to retrieve the file.
      ...
      :param id [int] The unique ID number of the report to retrieve
      :return ReportModel
    """
    def get_report(self, id):
        return requests.get(f"{self.base_url}/api/v2/reports/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def initiate_export_document_line_report(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/reports/exportdocumentline/initiate", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def list_reports(self):
        return requests.get(f"{self.base_url}/api/v2/reports", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def create_settings(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/settings", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Mark the setting object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this setting.
      :param id [int] The ID of the setting you wish to delete.
      :return ErrorDetail
    """
    def delete_setting(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/settings/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get a single setting object by its unique ID.
      ...
      :param companyId [int] The ID of the company that owns this setting
      :param id [int] The primary key of this setting
      :return SettingModel
    """
    def get_setting(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/settings/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_settings_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/settings", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_settings(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/settings", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing setting object at this URL with an updated object.
      ...
      :param id [int] The ID of the setting you wish to update
      :param model [SettingModel] The setting you wish to update.
      :return SettingModel
    """
    def update_setting(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/settings/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Get the subscription object identified by this URL.
      ...
      :param accountId [int] The ID of the account that owns this subscription
      :param id [int] The primary key of this subscription
      :return SubscriptionModel
    """
    def get_subscription(self, accountId, id):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/subscriptions/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_subscriptions_by_account(self, accountId, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/subscriptions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_subscriptions(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/subscriptions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def create_tax_codes(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/taxcodes", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the existing TaxCode object at this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this tax code.
      :param id [int] The ID of the tax code you wish to delete.
      :return ErrorDetail
    """
    def delete_tax_code(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/taxcodes/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the taxcode object identified by this URL.
      ...
      :param companyId [int] The ID of the company that owns this tax code
      :param id [int] The primary key of this tax code
      :return TaxCodeModel
    """
    def get_tax_code(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/taxcodes/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_tax_codes_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/taxcodes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_tax_codes(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/taxcodes", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing taxcode object at this URL with an updated object.
      ...
      :param id [int] The ID of the tax code you wish to update
      :param model [TaxCodeModel] The tax code you wish to update.
      :return TaxCodeModel
    """
    def update_tax_code(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/taxcodes/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def build_tax_content_file(self, model):
        return requests.post(f"{self.base_url}/api/v2/pointofsaledata/build", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Builds a tax content file containing information useful for a retail point-of-sale solution.
      ...
      :param id [int] The ID number of the location to retrieve point-of-sale data.
      ...
      :return String
    """
    def build_tax_content_file_for_location(self, companyId, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/locations/{id}/pointofsaledata", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def download_tax_rates_by_zip_code(self, date):
        return requests.get(f"{self.base_url}/api/v2/taxratesbyzipcode/download/{date}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def create_tax_rules(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/taxrules", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Mark the TaxRule identified by this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this tax rule.
      :param id [int] The ID of the tax rule you wish to delete.
      :return ErrorDetail
    """
    def delete_tax_rule(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/taxrules/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the taxrule object identified by this URL.
      ...
      :param companyId [int] The ID of the company that owns this tax rule
      :param id [int] The primary key of this tax rule
      :return TaxRuleModel
    """
    def get_tax_rule(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/taxrules/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_tax_rules(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/taxrules", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_tax_rules(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/taxrules", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing taxrule object at this URL with an updated object.
      ...
      :param id [int] The ID of the tax rule you wish to update
      :param model [TaxRuleModel] The tax rule you wish to update.
      :return TaxRuleModel
    """
    def update_tax_rule(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/taxrules/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def add_lines(self, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/transactions/lines/add", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def adjust_transaction(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/adjust", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def audit_transaction(self, companyCode, transactionCode):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/audit", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def audit_transaction_with_type(self, companyCode, transactionCode, documentType):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/types/{documentType}/audit", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def bulk_lock_transaction(self, model):
        return requests.post(f"{self.base_url}/api/v2/transactions/lock", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def change_transaction_code(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/changecode", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def create_or_adjust_transaction(self, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/transactions/createoradjust", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def create_transaction(self, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/transactions/create", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def delete_lines(self, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/transactions/lines/delete", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def get_transaction_by_code(self, companyCode, transactionCode, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def get_transaction_by_code_and_type(self, companyCode, transactionCode, documentType, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/types/{documentType}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Get the unique transaction identified by this URL.
      ...
      * LinesOnly (omit details - reduces API response size)
      ...
      :param id [int] The unique ID number of the transaction to retrieve
      :param include [string] Specifies objects to include in this fetch call
      :return TransactionModel
    """
    def get_transaction_by_id(self, id, include=None):
        return requests.get(f"{self.base_url}/api/v2/transactions/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def list_transactions_by_company(self, companyCode, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyCode}/transactions", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def lock_transaction(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/lock", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def refund_transaction(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/refund", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def settle_transaction(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/settle", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def verify_transaction(self, companyCode, transactionCode, model, include=None):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyCode}/transactions/{transactionCode}/verify", 
                auth=self.auth, headers=self.client_header,
                params=include, json=model)
    ...
    def create_u_p_cs(self, companyId, model):
        return requests.post(f"{self.base_url}/api/v2/companies/{companyId}/upcs", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Marks the UPC object identified by this URL as deleted.
      ...
      :param companyId [int] The ID of the company that owns this UPC.
      :param id [int] The ID of the UPC you wish to delete.
      :return ErrorDetail
    """
    def delete_u_p_c(self, companyId, id):
        return requests.delete(f"{self.base_url}/api/v2/companies/{companyId}/upcs/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    Get the UPC object identified by this URL.
      ...
      :param companyId [int] The ID of the company that owns this UPC
      :param id [int] The primary key of this UPC
      :return UPCModel
    """
    def get_u_p_c(self, companyId, id):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/upcs/{id}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_u_p_cs_by_company(self, companyId, include=None):
        return requests.get(f"{self.base_url}/api/v2/companies/{companyId}/upcs", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    def query_u_p_cs(self, include=None):
        return requests.get(f"{self.base_url}/api/v2/upcs", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing UPC object at this URL with an updated object.
      ...
      :param id [int] The ID of the UPC you wish to update
      :param model [UPCModel] The UPC you wish to update.
      :return UPCModel
    """
    def update_u_p_c(self, companyId, id, model):
        return requests.put(f"{self.base_url}/api/v2/companies/{companyId}/upcs/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def create_users(self, accountId, model):
        return requests.post(f"{self.base_url}/api/v2/accounts/{accountId}/users", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    Get the user object identified by this URL.
      ...
      :return UserModel
    """
    def get_user(self, id, accountId, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/users/{id}", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    """
    def get_user_entitlements(self, id, accountId):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/users/{id}/entitlements", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_users_by_account(self, accountId, include=None):
        return requests.get(f"{self.base_url}/api/v2/accounts/{accountId}/users", 
                auth=self.auth, headers=self.client_header,
                params=include)
    ...
    Replace the existing user object at this URL with an updated object.
      ...
      :param id [int] The ID of the user you wish to update.
      :param accountId [int] The accountID of the user you wish to update.
      :param model [UserModel] The user object you wish to update.
      :return UserModel
    """
    def update_user(self, id, accountId, model):
        return requests.put(f"{self.base_url}/api/v2/accounts/{accountId}/users/{id}", 
                auth=self.auth, headers=self.client_header,
                json=model)
    ...
    def get_my_subscription(self, serviceTypeId):
        return requests.get(f"{self.base_url}/api/v2/utilities/subscriptions/{serviceTypeId}", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    def list_my_subscriptions(self):
        return requests.get(f"{self.base_url}/api/v2/utilities/subscriptions", 
                auth=self.auth, headers=self.client_header,
                params=None)
    ...
    """
    def ping(self):
        return requests.get(f"{self.base_url}/api/v2/utilities/ping", 
                auth=self.auth, headers=self.client_header,
                params=None)
